...
import { IconMenu2, IconTerminal, IconX } from "@tabler/icons-react";
import {
  motion,
  AnimatePresence,
  useScroll,
...
export const NavbarLogo = ({ visible }: { visible?: boolean }) => {
  return (
    <motion.a
      href="#"
      className="relative z-20 mr-4 flex items-center space-x-1 px-2 py-1 text-green-400 dark:text-green-300 font-mono text-lg font-bold"
      animate={{
        opacity: visible ? 0 : 1,
        x: visible ? -20 : 0,
      }}
